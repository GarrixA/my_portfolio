  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-center gap-10 px-[7%] lg:px-[10%] mx-auto mt-20 lg:mt-0">
      <div className="w-full text-left">
        ...
        <button className="text-base mt-6 px-6 py-2 bg-accent text-white font-bold rounded shadow-lg hover:bg-opacity-80 transition-all">
          Contact me
        </button>
      </div>

      <div className="w-full">
        <div className="w-full sm:max-w-80 lg:w-96 h-96 lg:float-right">
          <Image
            src={image1}
            alt="Profile Picture"
            width={384}
